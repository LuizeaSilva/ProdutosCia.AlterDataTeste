...
public class DecreaseQuantityCompanyProductRequestValidator : AbstractValidator<DecreaseQuantityCompanyProductRequest>
{
    private readonly ICompanyRepository _companyRepository;
    private readonly IProductRepository _productRepository;
    private readonly ICompanyProductRepository _companyProductRepository;
    
    public DecreaseQuantityCompanyProductRequestValidator(ICompanyRepository companyRepository, IProductRepository productRepository, ICompanyProductRepository companyProductRepository)
    {
    ...
    private async Task<bool> ExistCompanyProduct(DecreaseQuantityCompanyProductRequest request, CancellationToken cancellationToken)
    {
